...
namespace PizzaBox.Data.Migrations
{
    ...
    [Migration("20190902192757_addedaitems")]
    partial class addedaitems
    {
            ...
            modelBuilder.Entity("PizzaBox.Domain.Models.AddressedOrder", b =>
                {
                    ...
                    b.HasOne("PizzaBox.Domain.Models.OrderHistory")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("PizzaBox.Domain.Models.OrderHistory", b =>
                {
                    ...
                    b.HasOne("PizzaBox.Domain.Models.User", "User")
                        .WithOne("UserOrderHistory")
                        .HasForeignKey("PizzaBox.Domain.Models.OrderHistory", "UserId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
