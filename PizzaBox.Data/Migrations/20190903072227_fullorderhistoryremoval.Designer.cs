...
namespace PizzaBox.Data.Migrations
{
    ...
    [Migration("20190903072227_fullorderhistoryremoval")]
    partial class fullorderhistoryremoval
    {
            ...
            modelBuilder.Entity("PizzaBox.Domain.Models.User", b =>
                {
                    ...
                    b.Property<int?>("LatestOrderAddressedOrderId");
                    ...
                    b.HasIndex("LatestOrderAddressedOrderId");
            ...
            modelBuilder.Entity("PizzaBox.Domain.Models.User", b =>
                {
                    ...
                    b.HasOne("PizzaBox.Domain.Models.AddressedOrder", "LatestOrder")
                        .WithMany()
                        .HasForeignKey("LatestOrderAddressedOrderId");
                });
